bulid a login page and singup page and make sure that work and remove all mock data and more thast it and dont touch anythign else # Add Clerk Authentication
...
This setup is linked to the Clerk application `app_3GSB00H4dBNon26GoXBRKBSlsZP`. Always
pass `--app app_3GSB00H4dBNon26GoXBRKBSlsZP` to `clerk init` so the project links to
the right Clerk app.

If this is an existing project, run:

```bash
clerk init --app app_3GSB00H4dBNon26GoXBRKBSlsZP
```
...
```bash
clerk init --framework <framework> --pm <package-manager> --app app_3GSB00H4dBNon26GoXBRKBSlsZP
```
